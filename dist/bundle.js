(() => {
  var t = {
      ...
      417: (t) => {
        ...
        function i(t, r) {
          return !r || ("object" !== e(r) && "function" != typeof r)
            ? (function (t) {
                if (void 0 === t)
                ...
                value: function (t, e) {
                  if (o(f(h.prototype), "get", this).call(this, t)) {
                    for (
                      ...
                      i[a - 2] = arguments[a];
                    (r = o(f(h.prototype), "get", this).call(
                      this,
                      t
                    )).structureData.apply(r, [e].concat(i));
                  } else o(f(h.prototype), "set", this).call(this, t, e);
                },
              },
            ]) && n(s.prototype, l),
            h
      ...
      265: (t, e, r) => {
        ...
        t.exports.GameClient = function t(e) {
          ...
          if (
            (a(this, t),
            s(this, "type", "GameClient"),
            s(this, "users", new f(this)),
            !e)
          )
          ...
          if (
            ((r = r.toLowerCase()), !["bf3", "bf4", "mohw", "bfh"].includes(r))
          )
          ...
          (this.game = r),
            ...
            (this.axios = u.create(
              o(
                o(
                  {
                    baseURL: "https://battlelog.battlefield.com/".concat(
                      this.game
                    ),
                  },
                  n.axios
              ...
              (r = [
                {
                  key: "structureData",
                  value: function (t) {
                    i.structureData(this, t, { blacklist: ["badgePath", ""] });
                          ...
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 2:
                                return (
                                  (e = t.sent),
                                  this.structureData(e.data.soldiersBox, !0),
      ...
      933: (t, e, r) => {
        ...
        var s = r(679).Platoon,
          u = r(123),
          c = r(673).stringify,
          f = r(799).SoldiersManager,
          l = (r(36).Soldier, r(417).BattlelogMap),
          p = (function () {
            function t(e, r) {
              !(function (t, e) {
                if (!(t instanceof e))
                ...
                a(this, "platoons", new l()),
                a(this, "platoonFans", new l()),
                a(this, "friends", new l()),
                a(this, "platoon", void 0),
              ...
              (r = [
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    u.structureData(this, e, {
                      ...
                      e.user &&
                        (u.structureData(this, e.user, {
                          blacklist: ["gravatarMd5"],
                        }),
                        e.user.gravatarMd5 &&
                          (this.gravatarEmailHash = e.user.gravatarMd5)),
                      e.tenFriends &&
                        e.tenFriends.length &&
                        (this.friends = e.tenFriends.map(function (e) {
                          return new t(r.client, e);
                        })),
                      e.platoons &&
                        (this.platoons = e.platoons.map(function (t) {
                          return new s(r.client, t);
                        })),
                      e.platoonFans &&
                        (this.platoonFans = e.platoonFans.map(function (t) {
                          return new s(r.client, t);
                        })),
                      e.club && (this.platoon = new s(this.client, e.club)),
                      e.soldiersBox &&
                        this.soldiers.structureData(e.soldiersBox),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if ("x" === t.rating) throw Error("Ok coomer");
                    if (!["g", "pg"].includes(t.rating)) throw Error("");
                    if (
                      !t.default.startsWith("http://") &&
      ...
      352: (t, e, r) => {
        ...
        (t.exports = function () {
          ...
          (t.exports.BattlelogClient = c),
          (t.exports.GameClient = u),
          (t.exports.Platoon = s),
          (t.exports.User = a),
          (t.exports.UsersManager = f),
          (t.exports.utils = l);
      },
      123: (t) => {
        function e(t, e) {
              ...
              for (v.s(); !(m = v.n()).done; ) {
                ...
                if (!t[b])
                  throw Error(
                    "Option '".concat(
                      b,
                      "' is required. While it's not provided."
                    )
                  );
              }
            } catch (t) {
            ...
            for (
              var E = function () {
                  ...
                  if (i && i.length && !i.includes(t[o]))
                    throw Error(
                      "Option ".concat(o, " is required to be ").concat(
                        ((r = i.pop()),
                        ""
                          .concat(
                            i
                ...
                R = 0,
                P = Object.entries(n.requiredToBe);
              R < P.length;
              R++
            )
              E();
        ...
        (t.exports.getArticle = i),
          (t.exports.structureData = function (t, r) {
            var n =
              arguments.length > 2 && void 0 !== arguments[2]
                ? arguments[2]
                : {};
