  ...
  var t = {
    ...
    448 : (t, e, r) => {
      ...
      t.exports = function(t) {
        return new Promise(function(e, r) {
          ...
          if ((h.open(t.method.toUpperCase(),
                      a(m, t.params, t.paramsSerializer), !0),
               (h.timeout = t.timeout), (h.onreadystatechange = function() {
                 if (h && 4 === h.readyState &&
                     (0 !== h.status ||
                      (h.responseURL &&
    ...
    321 : (t, e, r) => {
      ...
      (u.prototype.request = function(t) {
        "string" == typeof t ? ((t = arguments[1] || {}).url = arguments[0])
                             : (t = t || {}),
        ...
        for (this.interceptors.request.forEach(function(
                 t) { e.unshift(t.fulfilled, t.rejected); }),
             this.interceptors.response.forEach(function(
                 t) { e.push(t.fulfilled, t.rejected); });
             e.length;
    ...
    782 : (t, e, r) => {
      ...
      (o.prototype.use = function(t, e) {
        ...
        n.forEach(this.handlers, function(e) { null !== e && t(e); });
      }), (t.exports = o);
    },
    97 : (t, e, r) => {
      "use strict";
    ...
    481 : (t) => {
      ...
      t.exports = function(t, e, r, n, o) {
        return ((t.config = e), r && (t.code = r), (t.request = n),
                (t.response = o), (t.isAxiosError = !0),
                (t.toJSON = function() {
                  return {
    ...
    109 : (t, e, r) => {
      ...
      t.exports = function(t) {
        ...
        return t ? (n.forEach(t.split("\n"), function(t) {
          if (((i = t.indexOf(":")), (e = n.trim(t.substr(0, i)).toLowerCase()),
               (r = n.trim(t.substr(i + 1))), e)) {
            if (a[e] && o.indexOf(e) >= 0)
              return;
            a[e] = "set-cookie" === e ? (a[e] ? a[e] : []).concat([ r ])
                                      : a[e] ? a[e] + ", " + r : r;
          }
        }), a) : a;
      };
    ...
    867 : (t, e, r) => {
      ...
      t.exports = {
        ...
        merge : function t() {
          var e = {};
          function r(r, n) {
            u(e[n]) && u(r) ? (e[n] = t(e[n], r))
                            : u(r) ? (e[n] = t({}, r))
                                   : i(r) ? (e[n] = r.slice()) : (e[n] = r);
          }
        ...
        trim : function(
            t) { return t.replace(/^\s*/, "").replace(/\s*$/, ""); },
        stripBOM : function(
    ...
    42 : (t, e, r) => {
      ...
      var f = r(123), l = r(265).GameClient,
          p = (function() {
            function t() {
    ...
    417 : (t) => {
      ...
      function i(t, r) {
        return !r || ("object" !== e(r) && "function" != typeof r) ? (function(
                                                                         t) {
          if (void 0 === t)
      ...
      t.exports.GameClient = function t(e) {
        ...
        (this.game = r), (this.client = e), n.axios || (n.axios = {}),
            (this.axios = u.create(
                 o(o({
                     baseURL :
                         "https://battlelog.battlefield.com/".concat(this.game),
                   },
                     n.axios),
    ...
    799 : (t, e, r) => {
      ...
      var a = r(36).Soldier, s = r(417).BattlelogMap,
          u = (function() {
            function t(e, r) {
              var n, o, i;
              !(function(t, e) {
    ...
    882 : (t, e, r) => {
      ...
      var s = r(933).User, u = r(417).BattlelogMap,
          c = (function() {
            function t(e) {
              var r, n, o;
              !(function(t, e) {
    ...
    933 : (t, e, r) => {
      ...
      var s = r(679).Platoon, u = r(123), c = r(673).stringify,
          ...
          l = (r(36).Soldier, r(417).BattlelogMap), p = (function() {
                                                      function t(e, r) {
                                                        !(function(t, e) {
                                                          if (!(t instanceof e))
                                                            throw new TypeError(
    ...
    352 : (t, e, r) => {
      ...
      (t.exports =
          ...
          (t.exports.Platoon = s), (t.exports.User = a),
          (t.exports.UsersManager = f), (t.exports.utils = l);
    },
    123 : (t) => {
      function e(t, e) {
        return (
    ...
    155 : (t) => {
      ...
      (n.nextTick =
          ...
          (n.version = ""), (n.versions = {}), (n.on = d), (n.addListener = d),
          (n.once = d), (n.off = d), (n.removeListener = d),
          (n.removeAllListeners = d), (n.emit = d), (n.prependListener = d),
    ...
    587 : (t) => {
      ...
      t.exports = function(t, r, n, o) {
        ...
        for (var c = 0; c < u; ++c) {
          ...
          y >= 0 ? ((f = d.substr(0, y)), (l = d.substr(y + 1)))
                 : ((f = d), (l = "")),
              (p = decodeURIComponent(f)), (h = decodeURIComponent(l)),
              e(i, p)
                  ? Array.isArray(i[p]) ? i[p].push(h) : (i[p] = [ i[p], h ])
                  : (i[p] = h);
        }
        return i;
      };
