  ...
  var t = {
      ...
      9282: (t, e, r) => {
        ...
        function k(t, e, r, n, o, i) {
          if (!(r in t) || !c(t[r], e[r])) {
            if (!n) {
              ...
              throw (
                ((s.actual = t), (s.expected = e), (s.operator = i.name), s)
              );
            }
            A({
              actual: t,
        ...
        function U(t, e, r, n) {
          ...
          if (r && !T(e, r, n, t)) throw e;
        }
        function N(t, e, r, n) {
          if (e !== E) {
            if (
              ("string" == typeof r && ((n = r), (r = void 0)), !r || T(e, r))
            ) {
              var o = n ? ": ".concat(n) : ".",
        ...
        var E = (function (t) {
          function e(t) {
            ...
            if (((Error.stackTraceLimit = 0), null != o))
              ...
              r = a(
                ...
                p(e).call(
                  ...
                  (function (t, e, r) {
                    ...
                    for (
                      var S = f[f.length - 1], E = l[l.length - 1];
                      S === E &&
              ...
              r =
                1 === E.length
                  ? a(this, p(e).call(this, "".concat(h, " ").concat(E[0])))
                  : a(
                      this,
                      p(e).call(
                        this,
            ...
            return (
              ...
              (r.expected = f),
              (r.operator = i),
              Error.captureStackTrace && Error.captureStackTrace(c(r), u),
              r.stack,
          ...
          var a = (function (r) {
            function a(r, i, c) {
              ...
              return (
                ...
                (u =
                  !f || ("object" !== n(f) && "function" != typeof f)
                    ? (function (t) {
                        if (void 0 === t)
                          throw new ReferenceError(
                            "this hasn't been initialised - super() hasn't been called"
          ...
          s(
            ...
            function (t, e, o) {
              ...
              if (
                ...
                u = "The ".concat(t, " ").concat(i, " ").concat(f(e, "type"));
              else {
                var p =
                  ("number" != typeof l && (l = 0),
                  l + ".".length > (s = t).length || -1 === s.indexOf(".", l)
                    ? "argument"
                    : "property");
                u = 'The "'
                  .concat(t, '" ')
      ...
      9158: (t, e, r) => {
        ...
        function U(t, e, r, n) {
          ...
          if (v(t)) {
            ...
            if (O(t)) return !(!O(e) || t.size !== e.size) && B(t, e, r, n, 2);
            if (m(t)) return !(!m(e) || t.size !== e.size) && B(t, e, r, n, 3);
            if (g(t)) {
              if (
                ((c = e),
        ...
        function B(t, e, r, n, o, i) {
          ...
          if (r && 5 === arguments.length) {
            ...
            if (0 !== u.length) {
              ...
              var h = s(e);
              if (u.length !== h.length && N(e, h).length !== f) return !1;
            } else {
              var d = s(e);
              if (0 !== d.length && 0 !== N(e, d).length) return !1;
            }
          }
          if (
            0 === i.length &&
        ...
        function q(t, e, r, n) {
          for (var o = a(t), i = 0; i < o.length; i++) {
            var c = o[i];
            if (U(e, c, r, n)) return t.delete(c), !0;
          }
          return !1;
        }
        function _(t) {
        ...
        function L(t, e, r, n, o, i) {
          for (var c = a(t), u = 0; u < c.length; u++) {
            var s = c[u];
            if (U(r, s, o, i) && U(n, e.get(s), o, i)) return t.delete(s), !0;
          }
          return !1;
        }
                ...
                if (null !== i) {
                  for (var f = a(e), l = 0; l < f.length; l++) {
                    ...
                    if ("object" === o(p) && null !== p) {
                      if (!q(i, p, r, n)) return !1;
                    } else if (!r && !t.has(p) && !q(i, p, r, n)) return !1;
                  }
                  return 0 === i.size;
                }
                return !0;
                ...
                if (null !== a) {
                  for (var h = c(e), d = 0; d < h.length; d++) {
                    var g = n(h[d], 2),
                      b = ((l = g[0]), g[1]);
                    if ("object" === o(l) && null !== l) {
                      if (!L(a, t, l, b, r, i)) return !1;
                    } else if (
                      !(
                        r ||
                        (t.has(l) && U(t.get(l), b, !1, i)) ||
                        L(a, t, l, b, !1, i)
                      )
                    )
                      return !1;
            ...
            for (; f < t.length; f++) {
              if (!p(t, f)) {
                ...
                for (var l = Object.keys(t); f < l.length; f++) {
                  var y = l[f];
                  if (!p(e, y) || !U(t[y], e[y], r, u)) return !1;
                }
                return l.length === Object.keys(e).length;
              }
              if (!p(e, f) || !U(t[f], e[f], r, u)) return !1;
            }
          for (f = 0; f < i.length; f++) {
            var h = i[f];
            if (!U(t[h], e[h], r, u)) return !1;
          }
          return !0;
        }
        t.exports = {
      ...
      417: (t) => {
        ...
        var l = (function (t) {
          ...
          function y() {
            return r(this, y), p.apply(this, arguments);
          }
          return (
            (c = y),
            (l = [
                ...
                value: function (t, e) {
                  if (o(f(y.prototype), "get", this).call(this, t)) {
                    for (
                      ...
                      i[a - 2] = arguments[a];
                    (r = o(f(y.prototype), "get", this).call(
                      this,
                      t
                    )).structureData.apply(r, [e].concat(i));
                  } else o(f(y.prototype), "set", this).call(this, t, e);
                },
              },
            ]) && n(c.prototype, l),
            y
      ...
      5265: (t, e, r) => {
        ...
        t.exports.GameClient = function t(e) {
          ...
          if (
            (a(this, t),
            c(this, "type", "GameClient"),
            c(this, "users", new f(this)),
            !e)
          )
      ...
      7799: (t, e, r) => {
        ...
        var a = r(4036).Soldier,
          c = r(417).BattlelogMap,
          u = (function () {
            function t(e, r) {
              var n, o, i;
              !(function (t, e) {
      ...
      6933: (t, e, r) => {
        ...
        var c = r(679).Platoon,
          ...
          l = (r(4036).Soldier, r(417).BattlelogMap),
          p = (function () {
            function t(e, r) {
              !(function (t, e) {
                if (!(t instanceof e))
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    u.structureData(this, e, {
                      ...
                      e.club && (this.platoon = new c(this.client, e.club)),
                      e.soldiersBox &&
      ...
      2352: (t, e, r) => {
        ...
        var a = r(6933).User,
          c = r(679).Platoon,
          u = r(5265).GameClient,
          s = r(9042).BattlelogClient,
          f = r(6882).UsersManager,
          l = (r(4036).Soldier, r(1842).ServerBrowser, r(2953).Server, r(1123));
        (t.exports = function () {
          for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++)
            e[r] = arguments[r];
          return n(s, e);
      ...
      5955: (t, e, r) => {
        ...
        if (u) var h = c(BigInt.prototype.valueOf);
