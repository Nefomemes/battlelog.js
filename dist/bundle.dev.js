(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("querystring"), require("axios"));
	else if(typeof define === 'function' && define.amd)
		define(["querystring", "axios"], factory);
	else if(typeof exports === 'object')
		exports["bljs"] = factory(require("querystring"), require("axios"));
	else
		root["bljs"] = factory(root["_"], root["_"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_querystring__, __WEBPACK_EXTERNAL_MODULE_axios__) {
  ...
  */
  ...
  _createClass(User, [{
    ...
    value: function structureData(data) {
      ...
      if (data.platoons) {
        var _iterator = _createForOfIteratorHelper(data.platoons),
            _step;
      ...
      if (data.platoonFans) {
        var _iterator2 = _createForOfIteratorHelper(data.platoonFans),
            _step2;

        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _platoon = _step2.value;
            this.platoons.structureData(_platoon.id, new Platoon(this.client, _platoon));
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
    ...
    value: function displayAvatarURL() {
      ...
      var _require5 = __webpack_require__(/*! querystring */ "querystring"),
...
/***/ "querystring":
/*!****************************************************************************************************!*\
  !*** external {"commonjs":"querystring","commonjs2":"querystring","amd":"querystring","root":"_"} ***!
  \****************************************************************************************************/
/***/ ((module) => {
